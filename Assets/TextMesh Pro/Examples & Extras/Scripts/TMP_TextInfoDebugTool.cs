...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        [Space(10)]
        [TextArea(2, 2)]
        public string ObjectLeaderboardElement;
        ...
        void OnDrawGizmos()
        {
            ...
            ObjectLeaderboardElement = "Characters: " + m_TextInfo.characterCount + "   Words: " + m_TextInfo.wordCount + "   Spaces: " + m_TextInfo.spaceCount + "   Sprites: " + m_TextInfo.spriteCount + "   Links: " + m_TextInfo.linkCount
